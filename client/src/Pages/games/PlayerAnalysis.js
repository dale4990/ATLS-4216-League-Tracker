...
function PlayerAnalysis ({matchData, data, summoner, result}) {
    ...
    const isRemake = matchData.gameDuration < 209;
    ...
    const getTeamLayout = (team, result, first) => {
        const textResult = isRemake ? "Remake" : (result ? "Victory" : "Defeat");
        ...
        return (
            <table result={textResult} className={`player-container ${first ? "top-container" : "bottom-container"}`}>
                ...
                <thead>
                    <tr>
                        <th colSpan="4" className="result-th" style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>
                            {!isRemake ? <span class="result" style={{color: result ? "#5383e8" : "#e84057"}}>{textResult}</span> : null}
                            {`(${isTeamBlue ? "Blue" : "Red"} Team)`}
                        </th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>Multikill</th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>KDA</th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>Damage</th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>Wards</th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>CS</th>
                        <th style={{borderBottomColor: isRemake ? "none" : (result ? "#2f436e" : "#703c47")}}>Item</th>
                    </tr>
                </thead>

                <tbody className={isRemake ? "remake" : (result ? "win" : "loss")}>
                    {team.map(player => {
                        const tdClass = isRemake ? "remake" : (result ? "win" : "loss");
                        ...
                        const getItems = () => {
                            ...
                            const itemDivs = items.map(item => {
                                if (item === 0) return <div className={i++ === 0 ? "first-item item" : "item"}><div className="no-item"></div></div>;
                                return (
                                    <div className={i++ === 0 ? "first-item item" : "item"}>
                        ...
                        return (
                            <tr result={textResult} class={`overview-player overview-player--${isRemake ? "REMAKE" : (result ? "WIN" : "LOSE")}${player.puuid === summoner ? " isme" : ""}`}>
                ...
                <ul>
                    ...
                    <li className="team-item">
                        <div style={{position: "relative"}}>
                            <span className="obj-icon" style={{color: color, width: "16px", height: "16px"}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                                    <path fill-rule="evenodd" clipRule="evenodd" d="M8 0L6 4L3 1V5H0L3 8V11L7 16H9L13 11V8L16 5H13V1L10 4L8 0ZM9 10.9999L10 8.99993L12 7.99993L11 9.99993L9 10.9999ZM4 7.99993L5 9.99993L7 10.9999L6 8.99993L4 7.99993Z" fill="currentColor"></path>
                    ...
                    <li className="team-item">
                        <div style={{position: "relative"}}>
                            <span className="obj-icon" style={{color: color, width: "16px", height: "16px"}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                                    <path fill-rule="evenodd" clipRule="evenodd" d="M4 4L8 0L11.9992 4L10.9982 5.0012L11 5H14L8 11L2 5H5L4 4ZM6.4 3.99963L8 2.4L9.6 3.99963L8 5.6L6.4 3.99963ZM8 12L12 8L10 16H6L4 8L8 12Z" fill="currentColor"></path>
                    ...
                    <li className="team-item">
                        <div style={{position: "relative"}}>
                            <span className="obj-icon" style={{color: color, width: "16px", height: "16px"}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                                    <path fill-rule="evenodd" clipRule="evenodd" d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" fill="currentColor"></path>
